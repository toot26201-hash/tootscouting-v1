...
if uploaded_file is not None:
        ...
        for i, row in dataframe.iterrows():
            ...
            if 'shot' in act or 'sh/a' in act:
                if is_success:
                    ...
                    if draw_mode Useful and (specific_type is None or specific_type == "passes" or specific_type == "all") and "Shots" in layers:
    ...
    def draw_premium_kde_heatmap(dataframe, ax):
        # تم تعديل ألوان الخريطة الحرارية لتبدأ بـ الأبيض الصافي وتنتهي باللون الأحمر التحذيري لتناسب خلفية الملعب البيضاء
