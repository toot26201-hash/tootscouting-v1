...
if uploaded_file is not None:
    ...
    # 2. تصنيف احترافي شامل
    def get_detailed_type(row):
    ...
    df['Detailed_Type'] = df.apply(get_detailed_type, axis=1)
    ...
    # اسم اللاعب في المنتصف كعلامة مائية
    ax.text(60, 40, selected_player, color='#D4AF37', fontsize=60, fontweight='bold', ha='center', va='center', alpha=0.1)
    ...
    st.info("💡 قم برفع ملف البيانات من القائمة الجانبية للبدء.")
