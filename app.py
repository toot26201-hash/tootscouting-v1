...
if uploaded_file is not None:
    ...
    if all(col in df.columns for col in ['x1', 'y1', 'x2', 'y2']):
        # تحجيم الإحداثيات (بضربها في أبعاد الملعب) لضمان الدقة
        ...
        # خيار الخريطة الحرارية في الـ Sidebar
        st.sidebar.markdown("### 🗺️ MAP TYPE")
        show_heatmap = st.sidebar.checkbox("Show Heatmap", value=False, help="Display a heatmap of player activity.")
