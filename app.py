...
if uploaded_file is not None:
    ...
    if all(col in df.columns for col in ['x1', 'y1', 'x2', 'y2']):
        ...
        for act in selected_actions:
            ...
            if cfg.get("is_arrow"):
                pitch.arrows(subset['x_scaled'], subset['y_scaled'], subset['x2_scaled'], subset['y2_scaled'], color=cfg['color'], width=2, headwidth=5, headlength=5, ax=ax)
