...
if uploaded_file is not None:
    ...
    if all(col in df.columns for col in ['x1', 'y1', 'x2', 'y2']):
        ...
        # 3. تصنيف الأكشن (تم دمجه للحفاظ على كل الأنواع)
        def classify(val):
            val = val.lower()
        ...
        configs = {
            ...
            "Cross": {"color": "#FFD700", "marker": None, "is_arrow": True}, # العرضيات ذهبي
            "Corner": {"color": "#00BFFF", "marker": "o", "is_arrow": False}, # الركنيات أزرق
