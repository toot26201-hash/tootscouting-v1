...
if uploaded_file is not None:
    ...
    if all(col in df.columns for col in required_columns):
        ...
        # -------------------------------------------------------------
        # 3. Tactical Classification Engine (Fixed Syntax Here)
        # -------------------------------------------------------------
        conditions = [
            # --- Offensive ---
        ...
        # Elegant Golden Centered Player Name
        player_display_name = selected_player if selected_player != "All Players" else "All Players"
        ax.text(60, 40, player_display_name, color='#D4AF37', fontsize=45, 
                fontweight='normal', fontstyle='italic', ha='center', va='center', alpha=0.18, zorder=1)
        ...
        if not filtered_df.empty:
            ...
            # Draw Arrows (Passes, Crosses, Corners)
            ...
            # Draw Dots & Shapes (Goals, Shots, Tackles, etc.)
            ...
            # Render Tactical Legend at the bottom
            if legend_elements:
