...
def draw_professional_heatmap(p_df, player_name):
    ...
    pitch.heatmap(bin_statistic, ax=ax, cmap=cmap, zorder=1, vmin=0, vmax=bin_statistic['statistic'].max() * 0.8)
    ax.text(60, 40, player_name, fontsize=20, color='#1e293b', alpha=0.15, fontweight='bold', ha='center', va='center', zorder=2)
    return fig, ax
